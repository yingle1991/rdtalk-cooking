...
heroText: How To Cook
tagline: 🚀今年两次被隔离在家，出不了门，会做饭人员比较紧张，只能往上找菜谱和做法，但是这些菜谱往往写法千奇百怪，经常中间莫名出来一些材料。对于习惯了形式语言的程序员来说极其不友好。所以准备用更清晰精准的描述来整理常见菜的做法，以方便程序员在家做饭。
actionText: 开始使用 →
...
features: # 可选的
  - title: 做菜准备
    details: 包含基础烹饪学习、食材准备、以及疫情期间唐山地区的买菜指南。
  - title: 食谱
    details: 全部实际操作，并以 Markdown 格式菜谱输出，内置自动化工具，以更少的配置完成更多的事。配合多维索引快速定位每个菜谱
  - title: 专业提升
    details: 如果你已经做了许多上面的菜，对于厨艺已经入门，帮助你学习更加高深的烹饪技巧。
...
::: tip
期待 更多的开发者参与进来，将来我们一起做小程序、APP

还希望大家多多 [:sparkling_heart:支持](/pages/1b12ed/) 哟，持续关注吧~
:::

<br/>

## 💎 公众号
`乐子侃生活`是本人对各种有趣的、好玩的、沙雕的创意和想法以在线小网站或者文章的形式表达出来，比如：
...
::: center
<img src="https://cloud.rdtalk.cn/main/qrcode_for_gh_81ff60cc4083_258.jpg"  style="width:190px;" />
:::
